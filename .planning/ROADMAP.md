...
- [ ] 06-02-PLAN.md -- Email-sender refactor: replace mailto: with relay-based sending
- [ ] 06-03-PLAN.md -- Send UI: confirmation dialog, progress modal, Track page failed/retry, End Campaign
**UI hint**: yes
