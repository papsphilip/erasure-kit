...
export function WelcomeScreen() {
  ...
  return html`
    <div class="max-w-2xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
      <!-- Shield emoji -->
      <div class="text-6xl mb-8 text-center">${'\u{1F6E1}\u{FE0F}'}</div>

      <!-- Hero heading -->
      <h1 class="text-3xl sm:text-4xl font-semibold text-center leading-none mb-5">Take back your data</h1>

      <!-- Body paragraph -->
      <p class="text-lg text-[var(--ek-text-muted)] text-center mb-10 leading-relaxed">
      ...
      <!-- 4 step bullets -->
      <div class="flex flex-col gap-4 mb-10 mx-auto w-fit">
        <div class="flex items-center gap-3">
          <svg class="w-5 h-5 text-[var(--ek-primary)] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
          <span class="text-base">Enter your identity details</span>
        </div>
        <div class="flex items-center gap-3">
          <svg class="w-5 h-5 text-[var(--ek-primary)] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4"/></svg>
          <span class="text-base">Select brokers holding your data</span>
        </div>
        <div class="flex items-center gap-3">
          <svg class="w-5 h-5 text-[var(--ek-primary)] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
          <span class="text-base">A temp @erasurekit.uk address sends requests for you</span>
        </div>
        <div class="flex items-center gap-3">
          <svg class="w-5 h-5 text-[var(--ek-primary)] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
          <span class="text-base">Track responses and enforce deadlines</span>
        </div>
      </div>
      ...
      ${isReturning ? html`
        ...
        <p class="text-base text-[var(--ek-text-muted)] text-center mb-2">
          You have an unsaved campaign with ${emailCount} email${emailCount !== 1 ? 's' : ''} to erase
        </p>
        ${campaign.value.tempEmail && html`
          <p class="text-base text-[var(--ek-text-muted)] text-center mb-4">
      ...
      <!-- Privacy statement -->
      <p class="text-sm text-[var(--ek-text-muted)] text-center mt-10 flex items-center justify-center gap-2">
